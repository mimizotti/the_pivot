...
toy_collection = [Item.create(title: "Picachu", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "pikachu.jpeg"),
Item.create(title: "Legos", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "lego-park-lego-furniture.jpg"),
Item.create(title: "Train Set", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "mountain-town-wooden-train-set.jpg"),
Item.create(title: "Buzz Lightyear", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "buzz_lightyear.jpg"),
Item.create(title: "Cabbage Patch", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "cabbage_patch.jpeg"),

Item.create(title: "GI Joe", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "gi-joe.jpg"),
Item.create(title: "Teddy Ruxpin", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "teddy_ruxpin.jpg"),
Item.create(title: "Lite Brite", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "lite_brite.jpeg"),
Item.create(title: "Garfield Stuffed Animal", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "garfield.jpg"),
Item.create(title: "Fisher Price Medical Kit", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "fisher_price_medical_kit.jpg"),

Item.create(title: "Care Bears", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "care_bears.jpeg"),
Item.create(title: "Teenage Mutant Ninja Turtles", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "tmnt.jpg"),
Item.create(title: "Big Wheel", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "big_wheel.jpg"),
Item.create(title: "View Master", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "viewmaster.jpg"),
Item.create(title: "Barbie", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "barbie.jpg"),

Item.create(title: "Transformers", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "transformers.jpg"),
Item.create(title: "Smurfs", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "smurfs.jpg"),
Item.create(title: "Pound Puppies", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "pound_puppies.jpg"),
Item.create(title: "Thunder Cats", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "thundercats.jpg"),
Item.create(title: "My Little Pony", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Uncle Randy's Toy Shop"), price: rand(1..100), image: "my_little_pony.jpeg"),

Item.create(title: "Speak & Spell", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "speak_and_spell.jpg"),
Item.create(title: "Little Tikes Cozy Coupe", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "little_tikes_car.jpeg"),
Item.create(title: "Super Soaker", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "super_soaker.jpg"),
Item.create(title: "Talkboy", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "talkboy.jpg"),
Item.create(title: "Tamagotchi", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "tamagotchi.png"),

Item.create(title: "Crossfire", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "Crossfire.jpg"),
Item.create(title: "Polly Pocket", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "polly_pocket.jpg"),
Item.create(title: "Treasure Trolls", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "treasure_trolls.jpg"),
Item.create(title: "Creepy Crawlers", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "creepycrawlers.jpg"),
Item.create(title: "Tickle Me Elmo", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "tickle_me_elmo.jpeg"),

Item.create(title: "Furby", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "furby.jpg"),
Item.create(title: "Street Sharks", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "street_sharks.jpeg"),
Item.create(title: "Batman", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "batman.jpg"),
Item.create(title: "Easy-Bake Oven", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "easy_bake_oven.jpg"),
Item.create(title: "Skip-It", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "Skip_it.jpg"),

Item.create(title: "Power Rangers", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "power_rangers.jpeg"),
Item.create(title: "Beanie Babies", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "beanie_babies.jpg"),
Item.create(title: "Silly Putty", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "silly_putty.jpg"),
Item.create(title: "Slinky", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "slinky.jpeg"),
Item.create(title: "Indiana Jones", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "indiana_jones.JPG"),

Item.create(title: "Hungry Hungry Hippos", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "hungry_hungry_hippos.jpeg"),
Item.create(title: "Mr. Potato Head", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "Mr._Potato_Head.png"),
Item.create(title: "Alf", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "alf.jpg"),
Item.create(title: "Pogo Ball", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "pogo_ball.jpg"),
Item.create(title: "See N Say", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "see_and_say.jpeg"),

Item.create(title: "Play Doh", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "play_doh.jpeg"),
Item.create(title: "Antique Viewmaster", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "antique_viewmaster.jpg"),
Item.create(title: "Hot Wheels", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "hotwheels.jpeg"),
Item.create(title: "YoYo", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "yoyo.jpg"),
Item.create(title: "Pogs", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Toytastic Shop"), price: rand(1..100), image: "pogs.jpg")]
...
car_collection = [Item.create(title: "Dodge Ram 1500", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_ram1500.jpeg"),
Item.create(title: "Dodge Ram 2500", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_ram2500.jpeg"),
Item.create(title: "Dodge Ram 3500", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_ram3500.jpeg"),
Item.create(title: "Dodge Journey", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_journey.jpg"),
Item.create(title: "Dodge Durango", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "Dodge_Durango.jpg"),

Item.create(title: "Dodge Canyonero", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_canyonero.jpeg"),
Item.create(title: "Dodge Grand Caravan", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "Dodge-Caravan.jpg"),
Item.create(title: "Dodge Demon", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_demon.jpg"),
Item.create(title: "Dodge Charger", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_charger.jpg"),
Item.create(title: "Dodge Challenger", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_challenger.jpg"),

Item.create(title: "Dodge Dart", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_dart.png"),
Item.create(title: "Dodge Ram Promaster", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_limited_tungsten.jpg"),
Item.create(title: "Dodge Viper", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_harvest_edition.jpg"),
Item.create(title: "Dodge Viper 95", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "1995_dodge_viper.jpeg"),
Item.create(title: "Dodge Challenger 2010", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Double A's Dodge Dealership"), price: rand(1000..50000), image: "dodge_challenger.jpg"),


Item.create(title: "Acura Integra 1989", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "acura_integra_1989.jpg"),
Item.create(title: "AMG Hammer 1987", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "amg_hammer_87.jpg"),
Item.create(title: "Audi Quattro", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "audi_quattro.jpg"),
Item.create(title: "BMW M3 1990", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "1990-BMW-M3-Sport-Evolution-Front.jpg"),
Item.create(title: "Buick Grand National 1987", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "1987_buick_grand_national.JPG"),

Item.create(title: "Chevrolet Camaro IROC-Z 1986", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "86_camaro.JPG"),
Item.create(title: "DeLorean DMC-12 1982", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "delorean_82.jpg"),
Item.create(title: "Dodge Omni Shelby 1985", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "dodge_omni_1985.jpg"),
Item.create(title: "Ferrari F40 1990", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "1990_ferrari_f40.jpg"),
Item.create(title: "Ferrari Testarossa 1989", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "ferrari_testarossa_89.jpg"),

Item.create(title: "Ford Mustang 1990", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "90_mustang.jpeg"),
Item.create(title: "Honda CRX Si 1986", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "honda_crx_86.jpg"),
Item.create(title: "Jeep Cherokee 1996", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "jeep_cherokee_96.jpeg"),
Item.create(title: "Lamborghini Countach 1979", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "lamborghini-countach-1979.jpg"),
Item.create(title: "Mazda 323 GTX 1988", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "1987-Mazda-RX-7-Turbo-II-07.jpg"),

Item.create(title: "Mazda RX-7 Turbo 2 1987", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "mazda_323_gtx_1988.JPG"),
Item.create(title: "Merkur XR4Ti 1986", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "merkur_1986.jpg"),
Item.create(title: "Mitsubishi Starion 1984", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "mitsubishi_starion_1984.jpg"),
Item.create(title: "Porche 944 Turbo 1988", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "1988-Porsche-944-Turbo-S.jpg"),
Item.create(title: "Porche 959 1989", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Joel's 80's Rustbuckets"), price: rand(1000..50000), image: "1989_Porsche_959.jpg"),


Item.create(title: "Ford KA", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "Ford_Ka.jpg"),
Item.create(title: "Ford Focus 2000", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "2000_ford_focus.jpg"),
Item.create(title: "Ford Fiesta 2004", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "2004-ford-fiesta.jpeg"),
Item.create(title: "Ford Fusion 2000", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford_fusion.jpg"),
Item.create(title: "Ford Taurus 2000", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "2000-Taurus.jpg"),

Item.create(title: "Ford Focus rS 2016", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "2016-Ford-Focus-RS.jpg"),
Item.create(title: "Ford Mustang 1965", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "1965-Ford-Mustang.jpg"),
Item.create(title: "Ford B-Max 2012", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "Ford-B-MAX-2012.jpg"),
Item.create(title: "Ford C-Max 2003", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford_cmax_2003.jpg"),
Item.create(title: "Ford S-Max 2009", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford_smax_2009.jpeg"),


Item.create(title: "Ford Galaxy 2010", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford_galaxy2010.jpg"),
Item.create(title: "Ford Ecosport 2009", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford-ecosport-2009.jpg"),
Item.create(title: "Ford Kuga 2004", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford_kuga_2004.jpeg"),
Item.create(title: "Ford Flex 2009", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "ford_flex_2009.jpg"),
Item.create(title: "Ford Edge 2011", description: Faker::Hipster.sentence, store_id: Store.find_by(name: "Dan Phillips Car Emporium"), price: rand(1000..50000), image: "2011-ford-edge.jpg")]
...
ants = Store.create!(name: "Ants in My Eyes Johnson's", description: "Our prices, I hope, aren't too low!", image: "j-peterman.png")
    ...
    clothes_items = [
      Item.create(store: store_1, title: "White Dress", description: "With cool designs", price: Faker::Commerce.price),
